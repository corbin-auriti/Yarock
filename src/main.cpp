...
int main(int argc, char *argv[])
{
    ...
    LoadTranslation("yarock", QLatin1String("/usr/share/locale/yarock"), language);
    ...
    QDir().mkpath(UTIL::CONFIGDIR + "/download");
    ...
    mainwindow.commandlineOptionsHandle(options);
