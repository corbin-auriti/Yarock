...
RepeatControl::RepeatControl(QWidget *parent)  : QToolButton( parent )
{
    ...
    this->setIcon(QIcon(":/images/media-repeat-1-64x64.png"));
...
void RepeatControl::setState(int intState)
{
    ...
    switch(m_state) {
      ...
      break;
      case RepeatTrack :
         this->setIcon(QIcon(":/images/media-repeat-2-64x64.png"));
         this->setToolTip(tr("Repeat track"));
      break;
      case RepeatAll :
         this->setIcon(QIcon(":/images/media-repeat-3-64x64.png"));
...
ShuffleControl::ShuffleControl(QWidget *parent)  : QToolButton( parent )
{
    ...
    this->setIconSize( QSize( 20, 20 ) );
    this->setFixedSize( QSize( 26, 26 ) );
    this->setIcon(QIcon(":/images/media-shuffle-1-64x64.png"));
...
void ShuffleControl::setState(int intState)
{
    ...
    switch(m_state) {
      ...
      break;
      case ShuffleOn :
         this->setIcon(QIcon(":/images/media-shuffle-2-64x64.png"));
